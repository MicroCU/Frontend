...
export const mockData: IMockDirectedGraphData[] = [
  ...
  },
  {
    groups: [
      ...
      {
        id: "7",
        name: "Lesson II abbcvgdvcgsgvcdhsdcghvcfhvhgcvgvfhcvvdhcvdvh",
        next: [],
        type: GroupTypeEnum.Unordered,
        members: [
          {
  ...
  },
  {
    groups: [
      ...
      {
        id: "7",
        name: "Python Final Test",
        next: [],
        type: GroupTypeEnum.Unordered,
        members: [
          {
            id: "71",
            name: "Python Final Test 1",
            progress: 10,
            type: MicroTypeEnum.VIDEO
          },
          {
            id: "72",
            name: "Python Final Test 2",
            progress: 40,
            type: MicroTypeEnum.VIDEO
          }
        ]
      ...
      },
      {
        ...
        members: [
          {
            id: "111",
            name: "Lesson 1* longlonglonglonglonglong",
            progress: 0,
            type: MicroTypeEnum.VIDEO
          },
          {
            id: "112",
            name: "Lesson 2* longlonglonglonglonglong",
            progress: 0,
            type: MicroTypeEnum.VIDEO
          },
          {
            id: "113",
            name: "Lesson 3* longlonglonglonglonglong",
            progress: 0,
            type: MicroTypeEnum.VIDEO
          },
          {
