...
export const mockData: MockDirectedGraphData = {
    ...
    groups: [
        ...
        {
            id: '5', name: 'Control Flow', next: ['7'], type: GroupTypeEnum.Ordered,
            members: [
        ...
        {
            id: '90', name: 'Operator *', next: ['70'], type: GroupTypeEnum.Single,
            members: [
        ...
        {
            id: '13', name: 'Lesson II abbcvgdvcgsgvcdhsdcghvcfhvhgcvgvfhcvvdhcvdvh', next: ['15'], type: GroupTypeEnum.Unordered,
            members: [
