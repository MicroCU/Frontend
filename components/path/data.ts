...
export const mockData: IMockDirectedGraphData = {
    groups: [
        ...
        },
        {
            ...
            members: [
                { id: '21', name: 'Comment 111111111111111111111111111111111111', progress: 0, type: MicroTypeEnum.PRACTICE },
                { id: '22', name: 'Comment 222222222222222222222222222222222222', progress: 0, type: MicroTypeEnum.PRACTICE },
                { id: '23', name: 'Comment 333333333333333333333333333333333333', progress: 0, type: MicroTypeEnum.PRACTICE },
            ]
        },
        {
