...
function UnorderedGroup({ id, data }: { id: string; data: Group }) {
  ...
  const { isOverflow, microsWidth } = useOverflowDetectionWithMicrosWidth(
    microsWidthRef,
    titleWidthRef
  );
  return (
    <div className="flex flex-col bg-white w-fit h-fit justify-center content-center gap-y-4 rounded-2xl p-4">
      ...
      <div
        className="flex flex-row bg-white w-fit h-fit justify-center content-center gap-x-4 rounded-2xl"
        ref={microsWidthRef}
      >
